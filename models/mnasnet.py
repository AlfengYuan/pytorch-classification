...
def mnasnet0_5(pretrained=False, checkpoints=None, progress=True, **kwargs):
...
def mnasnet0_75(pretrained=False, checkpoints=None, progress=True, **kwargs):
...
def mnasnet1_0(pretrained=False, checkpoints=None, progress=True, **kwargs):
...
def mnasnet1_3(pretrained=False, checkpoints=None, progress=True, **kwargs):
