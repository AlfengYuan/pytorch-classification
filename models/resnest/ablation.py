...
def resnest50_fast_1s1x64d(pretrained=False, checkpoints=None, progress=True, **kwargs):
...
def resnest50_fast_2s1x64d(pretrained=False, checkpoints=None, progress=True, **kwargs):
    model = ResNet(Bottleneck, [3, 4, 6, 3],
...
def resnest50_fast_4s1x64d(pretrained=False, checkpoints=None, progress=True, **kwargs):
    model = ResNet(Bottleneck, [3, 4, 6, 3],
...
def resnest50_fast_1s2x40d(pretrained=False, checkpoints=None, progress=True, **kwargs):
    model = ResNet(Bottleneck, [3, 4, 6, 3],
...
def resnest50_fast_2s2x40d(pretrained=False, checkpoints=None, progress=True, **kwargs):
    model = ResNet(Bottleneck, [3, 4, 6, 3],
...
def resnest50_fast_4s2x40d(pretrained=False, checkpoints=None, progress=True, **kwargs):
    model = ResNet(Bottleneck, [3, 4, 6, 3],
...
def resnest50_fast_1s4x24d(pretrained=False, checkpoints=None, progress=True, **kwargs):
    model = ResNet(Bottleneck, [3, 4, 6, 3],
